...
model RLC
  Modelica.Electrical.Analog.Sources.SineVoltage sineVoltage(V = 1, freqHz = 50);
  Modelica.Electrical.Analog.Basic.Resistor resistor(R = 1);
  Modelica.Electrical.Analog.Basic.Capacitor capacitor(C = 0.00001);
...
equation
  ...
  connect(sineVoltage.n, capacitor.n);
